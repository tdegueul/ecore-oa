...
class GraphvizTFSMAlgebra extends GraphvizFSMAlgebra implements TFSMAlgebra<GraphvizExp, GraphvizStateExp, GraphvizExp, GraphvizExp, GraphvizExp, GraphvizExp> {
	override timedFsm(List<? extends GraphvizStateExp> states, List<? extends GraphvizExp> transitions,
		GraphvizStateExp initialState, String name, List<? extends GraphvizExp> clocks) {
	...
	override GraphvizStateExp timedState(String name, GraphvizExp fsm, List<? extends GraphvizExp> outgoingtransitions,
		...
		[
			this.state(name, fsm, outgoingtransitions, incommingtransitions).evalGraph
		]
	}

	override GraphvizStateExp timedInitialState(String name, GraphvizExp fsm,
		List<? extends GraphvizExp> outgoingtransitions, List<? extends GraphvizExp> incommingtransitions,
		GraphvizExp stateguard) {
			[
